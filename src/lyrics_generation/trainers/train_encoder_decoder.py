...
def train(conf: omegaconf.DictConfig) -> None:
    ...
    #     pl_module = EncoderDecoderModule.load_from_checkpoint(conf.model.training_checkpoint_to_load,
    #     hparams_file=current_conf_path)
    ...
    # os.system('clear')
    print(conf_str)
    print('training_set:', len(pl_data_module.training_dataset))
    print('dev_set:', len(pl_data_module.dev_dataset))
    print('test_set:', len(pl_data_module.test_dataset))
    if 'training_checkpoint_to_load' in conf.model:
        trainer.fit(pl_module, datamodule=pl_data_module,
                    ckpt_path=conf.model.training_checkpoint_to_load)
    else:
        trainer.fit(pl_module, datamodule=pl_data_module)
