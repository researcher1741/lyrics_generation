...
def train(conf: omegaconf.DictConfig) -> None:
    ...
    assert 'tokenizer_path' in conf.model or logger.warn(
        'Cannot proceed without having a specified tokenizer in model configuration. '
        'Please define tokenizer_path key in model config.')
